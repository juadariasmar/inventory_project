...
type PermisoTipo = 'VER_ANALISIS' | 'EXPORTAR_REPORTES' | 'REGISTRAR_MOVIMIENTOS'
...
const PERMISOS_DISPONIBLES: { valor: PermisoTipo; etiqueta: string; descripcion: string }[] = [
  ...
  },
  {
    ...
    descripcion: 'Permite registrar entradas y salidas de stock de los productos existentes.',
  },
]
