...
- **Minimal Interaction:** The user prefers direct execution over conversational gates. When a design or approach is clear, default to creating and executing rather than pausing for explicit approval.
